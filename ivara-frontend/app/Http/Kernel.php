...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\SetLocale::class, // Language detection middleware
        ],
    ...
    protected $routeMiddleware = [
        ...
        'ivara_role' => \App\Http\Middleware\IvaraRoleMiddleware::class,
        'category_access' => \App\Http\Middleware\CategoryAccess::class,
        'category.access' => \App\Http\Middleware\CategoryAccess::class,
    ];
}
