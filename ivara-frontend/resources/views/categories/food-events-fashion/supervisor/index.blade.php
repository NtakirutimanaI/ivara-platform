...
<div class="container-fluid p-5">
    <div class="text-center mb-5">
        <h1 class="fw-bold text-dark"><i class="fas fa-clipboard-check me-3"></i>Supervisor Dashboard</h1>
    ...
    <div class="row g-4">
        <div class="col-md-4">
             <div class="p-4 bg-white rounded shadow-sm border-start border-5 border-primary">
                 <h5 class="fw-bold">Team Overview</h5>
                 <p class="text-muted">Monitor active staff.</p>
             </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
             <div class="p-4 bg-white rounded shadow-sm border-start border-5 border-info">
                 ...
                 <p class="text-muted">Review latest tickets.</p>
             </div>
        </div>
    </div>
</div>
