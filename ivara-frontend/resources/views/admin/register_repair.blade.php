...
<body class="text-sm bg-gray-50 font-sans" style="margin-left:270px; margin-top:80px;">
  ...
  <div class="container mx-auto min-h-screen flex flex-col md:flex-row shadow-md bg-white rounded-lg overflow-hidden mt-4 px-4 md:px-0">
    ...
    <div class="md:w-1/2 w-full bg-cover bg-center relative" style="background-image: url('{{ asset('images/iPhone.png') }}'); min-height: 320px;">
      ...
      <div class="absolute bottom-6 left-6 text-white z-10 max-w-xs md:max-w-md" data-aos="fade-up">
        <h1 class="text-3xl font-bold mb-1">IVARA</h1>
    ...
    <div class="md:w-1/2 w-full flex flex-col justify-center items-center md:items-start p-6 space-y-6 bg-white">
      <div data-aos="fade-down" class="text-center w-full max-w-md">
        <img src="{{ asset('images/support3.png') }}" alt="IVARA Logo" class="mx-auto mb-2 max-w-full h-auto" style="width: 320px;">
        <p class="text-gray-600 text-sm">
          "Want to keep your device safe? Register it now with IVARA and ensure secure tracking!"
        </p>
      </div>

      <div class="space-y-3 w-full max-w-md" data-aos="fade-right">
        <a href="{{ url('register_device') }}" class="link-button link-button-indigo" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          <i class="fa-solid fa-shield-alt"></i> Register Device
        </a>

        <a href="{{ url('reports') }}" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          <i class="fa fa-users"></i> Reports
        </a>

        <a href="{{ url('repair_device') }}" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          <i class="fa fa-users"></i> Repair Device
        </a>

        <a href="{{ route('admin.register_view_data') }}" class="link-button link-button-blue-light" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          <i class="fa fa-bar-chart"></i> Device Owners
        </a>

        <a href="{{ route('admin.device') }}" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          <i class="fa fa-users"></i> Registered Devices
        </a>

        <a href="{{ route('admin.technicians') }}" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
