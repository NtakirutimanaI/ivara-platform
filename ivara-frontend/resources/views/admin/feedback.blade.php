...
<div class="container">
    ...
    <div class="filter-form">
        <form class="row g-3" method="GET" action="{{ route('admin.feedback.index') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-2 export-buttons">
                <a href="{{ route('admin.feedback.export', ['type' => 'excel']) }}" class="btn btn-sm btn-success"><i class="fa fa-file-excel"></i> Excel</a>
                <a href="{{ route('admin.feedback.export', ['type' => 'pdf']) }}" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf"></i> PDF</a>
                @if($feedbacks->count() > 0)
                    <a href="{{ route('admin.feedback.print', $feedbacks->first()->id) }}" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Print</a>
                @endif
            </div>
        </form>
    </div>
