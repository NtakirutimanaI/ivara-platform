  ...
  <script>
    ...
    new Chart(document.getElementById('inventoryChart'), {
      ...
      data: {
        ...
        datasets: [{ label: 'Stock', data: [30,25,40,25], backgroundColor: '#924FC2' }]
      },
    ...
    new Chart(document.getElementById('inventoryMiniChart'), {
      type: 'line',
      data: { labels:['Mon','Tue','Wed','Thu'], datasets:[{ data:[10,12,8,15], borderColor:'#924FC2', backgroundColor:'rgba(59,130,246,0.2)', fill:true, tension:0.3 }] },
    ...
    new Chart(document.getElementById('transactionsChart'), {
      type: 'doughnut',
      data: { labels:['Completed','Pending','Failed'], datasets:[{ data:[25,15,5], backgroundColor:['#924FC2','#facc15','#ef4444'] }] },
