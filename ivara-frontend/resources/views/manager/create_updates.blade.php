...
<div class="updates-form-container">
    ...
    <form action="{{ route('manager.updates.store') }}" method="POST" enctype="multipart/form-data" class="updates-form">
        @csrf
    ...
    <div class="updates-list">
        @forelse($updates as $update)
            <div>
                ...
                @endif
                <form action="{{ route('manager.updates.destroy', $update->id) }}" method="POST" class="remove-form">
                    @csrf
                    @method('DELETE')
