...
<head>
  ...
  <style>
    ...
    .hsidebar-nav a.active {
      background-color: #4f46e5; /* Highlighted blue */
    }
...
<body class="hsidebar-body">
  ...
  <nav class="hsidebar-nav">
    <a href="{{ route('manager.inventory') }}" class="active">Inventory</a>
    <a href="{{ route('manager.sales') }}">Sales</a>
    <a href="{{ route('manager.daily-transactions') }}">Daily Transactions</a>
  </nav>
