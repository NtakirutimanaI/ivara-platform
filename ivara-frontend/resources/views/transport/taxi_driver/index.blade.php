...
@section('title', 'Taxi Driver Dashboard')
...
<div class="transport-dashboard-container">
    <div class="container-fluid p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="fw-bold display-5 mb-1 text-primary">Taxi Driver Console</h1>
                <p class="text-muted lead mb-0">Manage your trips, vehicle, and earnings.</p>
            </div>
        ...
        <div class="bento-grid">
            ...
            <div class="bento-card bg-glass">
                <div class="card-icon bg-soft-primary text-primary"><i class="fas fa-route"></i></div>
                <h3 class="metric-value">12</h3>
                <span class="metric-label">Completed Trips</span>
            </div>
            
            <div class="bento-card bg-glass">
                <div class="card-icon bg-soft-warning text-warning"><i class="fas fa-wallet"></i></div>
                <h3 class="metric-value">45,000</h3>
                <span class="metric-label">Daily Earnings (RWF)</span>
            </div>

            <div class="bento-card bg-glass">
                <div class="card-icon bg-soft-success text-success"><i class="fas fa-star"></i></div>
                <h3 class="metric-value">4.9</h3>
                <span class="metric-label">Driver Rating</span>
            </div>

            <div class="bento-card bg-glass">
                <div class="card-icon bg-soft-info text-info"><i class="fas fa-gas-pump"></i></div>
                <h3 class="metric-value">75%</h3>
                <span class="metric-label">Fuel Level</span>
            </div>

            <!-- Current Request -->
            <div class="bento-card bg-glass span-2 row-2">
                <h5 class="card-title mb-3">Trip Queue</h5>
                <div class="list-group list-group-flush bg-transparent">
                    <div class="list-group-item bg-transparent d-flex justify-content-between align-items-center">
                        <div>
                            <span class="badge bg-danger me-2">Now</span>
                            <strong>Airport Pickup</strong>
                            <div class="small text-muted">Client: Jean Pierre - Gate 5</div>
                        </div>
                    ...
                    <div class="list-group-item bg-transparent d-flex justify-content-between align-items-center">
                        <div>
                            <span class="badge bg-warning me-2">Scheduled</span>
                             <strong>Corporate Drop-off</strong>
                            <div class="small text-muted">Kigali Heights - 14:00</div>
                        </div>
            ...
            <div class="bento-card bg-glass span-2">
                <h5 class="card-title mb-3">Vehicle Diagnostics</h5>
                <div class="d-flex gap-3">
                    <button class="btn btn-outline-primary flex-fill p-3"><i class="fas fa-oil-can d-block fs-3 mb-2"></i>Oil Status</button>
                    <button class="btn btn-outline-primary flex-fill p-3"><i class="fas fa-car-battery d-block fs-3 mb-2"></i>Battery</button>
                    <button class="btn btn-outline-primary flex-fill p-3"><i class="fas fa-tools d-block fs-3 mb-2"></i>Service</button>
                </div>
            </div>
