  ...
  <style>
    * {
    ...
    @media (max-width: 768px) {
      ...
      .dash-unique-table-header span:nth-child(3),
      .dash-unique-table-header span:nth-child(4),
      .dash-unique-table-row > div:nth-child(3),
      .dash-unique-table-row > div:nth-child(4) {
        display: none;
      }
    }
  </style>
